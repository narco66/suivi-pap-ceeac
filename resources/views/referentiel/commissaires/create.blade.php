<x-app-layout>
    ...
    <div class="card card-ceeac">
        ...
        <div class="card-body">
            <form method="POST" action="{{ route('commissaires.store') }}" id="commissaireForm">
                @csrf
                ...
                <div class="row mb-4">
                    <div class="col-md-4">
                        ...
                        >
                            ...
                            <option value="M." {{ old('titre') == 'M.' ? 'selected' : '' }}>M.</option>
                            <option value="Mme" {{ old('titre') == 'Mme' ? 'selected' : '' }}>Mme</option>
                            <option value="Dr" {{ old('titre') == 'Dr' ? 'selected' : '' }}>Dr</option>
                            <option value="Prof" {{ old('titre') == 'Prof' ? 'selected' : '' }}>Prof</option>
                            <option value="S.E." {{ old('titre') == 'S.E.' ? 'selected' : '' }}>S.E.</option>
                        </select>
                        @error('titre')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                ...
                <div class="d-flex gap-2 justify-content-end mt-4 pt-4 border-top">
                    ...
                    <button type="submit" class="btn btn-primary btn-ceeac">
                        <i class="bi bi-check-circle me-2"></i>Enregistrer le commissaire
                    </button>
                </div>
            </form>
        </div>
