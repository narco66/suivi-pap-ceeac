<x-app-layout>
    <x-slot name="header">
        <div class="d-flex justify-content-between align-items-center">
            <h2 class="mb-0 fw-bold text-ceeac-blue">
                <i class="bi bi-building me-2"></i>Créer un département
            </h2>
    ...
    <div class="card card-ceeac">
        ...
        <div class="card-body">
            ...
            <form method="POST" action="{{ route('departements.store') }}" id="departementForm">
                @csrf
                ...
                <div class="row g-3 mb-4">
                    <div class="col-md-4">
                        ...
                        <small class="form-text text-muted">
                            <i class="bi bi-info-circle me-1"></i>Code unique identifiant le département.
                        </small>
                    </div>
                    <div class="col-md-8">
                        ...
                        @enderror
                        <small class="form-text text-muted">
                            <i class="bi bi-info-circle me-1"></i>Nom complet du département.
                        </small>
                    </div>
                </div>
                ...
                <div class="row g-3 mb-4">
                    <div class="col-12">
                        ...
                        <textarea 
                            ...
                            name="description" 
                            rows="4"
                            placeholder="Description détaillée du département...">{{ old('description') }}</textarea>
                        @error('description')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                        <small class="form-text text-muted">
                            <i class="bi bi-info-circle me-1"></i>Description détaillée des missions et responsabilités du département.
                        </small>
                    </div>
                </div>
                ...
                <div class="row g-3 mb-4">
                    <div class="col-md-6">
                        ...
                        @enderror
                        <small class="form-text text-muted">
                            <i class="bi bi-info-circle me-1"></i>Statut du département dans le système.
                        </small>
                    </div>
                </div>
                ...
                <div class="d-flex gap-2 justify-content-end mt-4 pt-4 border-top">
                    ...
                    <button type="submit" class="btn btn-primary btn-ceeac">
                        <i class="bi bi-check-circle me-2"></i>Créer le département
                    </button>
                </div>
            </form>
        </div>
