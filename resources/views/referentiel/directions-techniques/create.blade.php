<x-app-layout>
    <x-slot name="header">
        <div class="d-flex justify-content-between align-items-center">
            <h2 class="mb-0 fw-bold text-ceeac-blue">
                <i class="bi bi-gear me-2"></i>Créer une direction technique
            </h2>
    ...
    <div class="card card-ceeac">
        <div class="card-header bg-ceeac-gradient text-white">
            <h5 class="mb-0">
                <i class="bi bi-gear me-2"></i>Informations de la direction technique
            </h5>
        </div>
        <div class="card-body">
            @if($errors->any())
            ...
            <form method="POST" action="{{ route('directions-techniques.store') }}" id="directionTechniqueForm">
                @csrf
                ...
                <div class="row g-3 mb-4">
                    <div class="col-md-4">
                        ...
                        <small class="form-text text-muted">
                            <i class="bi bi-info-circle me-1"></i>Code unique identifiant la direction technique.
                        </small>
                    </div>
                    <div class="col-md-8">
                        ...
                        @enderror
                        <small class="form-text text-muted">
                            <i class="bi bi-info-circle me-1"></i>Nom complet de la direction technique.
                        </small>
                    </div>
                </div>
                ...
                <div class="row g-3 mb-4">
                    <div class="col-md-6">
                        ...
                        @enderror
                        <small class="form-text text-muted">
                            <i class="bi bi-info-circle me-1"></i>Département auquel la direction technique est rattachée.
                        </small>
                    </div>
                    <div class="col-md-6">
                        ...
                        @enderror
                        <small class="form-text text-muted">
                            <i class="bi bi-info-circle me-1"></i>Statut de la direction technique dans le système.
                        </small>
                    </div>
                </div>
                ...
                <div class="row g-3 mb-4">
                    <div class="col-12">
                        ...
                        <textarea 
                            ...
                            name="description" 
                            rows="4"
                            placeholder="Description détaillée de la direction technique...">{{ old('description') }}</textarea>
                        @error('description')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                        <small class="form-text text-muted">
                            <i class="bi bi-info-circle me-1"></i>Description détaillée des missions et responsabilités de la direction technique.
                        </small>
                    </div>
                </div>
                ...
                <div class="d-flex gap-2 justify-content-end mt-4 pt-4 border-top">
                    ...
                    <button type="submit" class="btn btn-primary btn-ceeac">
                        <i class="bi bi-check-circle me-2"></i>Créer la direction technique
                    </button>
                </div>
            </form>
        </div>
