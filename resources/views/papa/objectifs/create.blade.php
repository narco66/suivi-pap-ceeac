            ...
            <form method="POST" action="{{ route('objectifs.store') }}" id="objectifForm">
                    ...
                    <div class="col-md-12">
                        ...
                        >
                            ...
                            @foreach($versions as $version)
                                <option value="{{ $version['id'] }}" {{ old('papa_version_id') == $version['id'] ? 'selected' : '' }}>
                                    {{ $version['libelle'] }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="progress progress-ceeac mt-2" style="height: 8px;">
                            <div 
                                ...
                                role="progressbar" 
                                id="progressBar"
                                style="width: {{ old('pourcentage_avancement', 0) }}%"
                                aria-valuenow="{{ old('pourcentage_avancement', 0) }}" 
                                aria-valuemin="0" 
                                aria-valuemax="100"
                            ></div>
                        </div>
                ...
                <div class="d-flex gap-2 justify-content-end mt-4 pt-4 border-top">
                    ...
                    <button type="submit" class="btn btn-primary btn-ceeac">
                        <i class="bi bi-check-circle me-2"></i>Enregistrer l'objectif
                    </button>
                </div>
            </form>
        </div>
