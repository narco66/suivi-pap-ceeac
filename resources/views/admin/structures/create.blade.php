    ...
    <x-slot name="header">
        <div class="d-flex justify-content-between align-items-center">
            <h2 class="mb-0 fw-bold text-ceeac-blue">
                <i class="bi bi-building-add me-2"></i>Créer une structure
            </h2>
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <select class="form-select @error('type') is-invalid @enderror" id="type" name="type" required>
                            <option value="direction" {{ old('type', 'direction') === 'direction' ? 'selected' : '' }}>Direction</option>
                    ...
                    <div class="col-12">
                        <button type="submit" class="btn btn-ceeac-primary">
                            <i class="bi bi-save me-2"></i>Créer la structure
                        </button>
